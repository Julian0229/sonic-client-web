...
const jobsTS = {
    ...
    cronInfo: {
        ...
        comma: "(,) a comma that expresses a list of values, such as 1,2,4\n" + "in the week field
            ", then it means Monday, Tuesday, Thursday",
        slash: "(/) slash, e.g. x/y , x is the start value, y is the step length, e.g. use \n" + " in the first (second) place
            "0/15, means start from 0 seconds and every 15 seconds",
...
const androidRemoteTS = {
    ...
    code: {
        ...
        remoteAppium: "remoteAppium",
        inttialized: "AppiumDriver is not initialized",
        UIAutomator2appiumInt: "Initialize UIAutomator2Server",
